...
const HomePage: React.FC<HomePageProps> = ({ txtVal, setTxtVal, setCountryData, jsonData, region, setRegion }) => {
  ...
  return (
    <div>
      <Inputa txtVal={txtVal} setTxtVal={setTxtVal} region={region} setRegion={setRegion} />
      <main>
